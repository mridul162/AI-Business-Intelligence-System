"""
Transformation logic for stock location records.
"""
...
class StockLocationTransformer:
    """Transform raw stock location records into staging-ready records."""
    ...
    def transform(
        ...
        """Transform one raw stock location record."""
        ...
        return {
            ...
            "location_type": self._clean_text(
