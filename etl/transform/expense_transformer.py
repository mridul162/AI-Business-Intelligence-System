"""
Transformation logic for expense records.
"""
...
class ExpenseTransformer:
    """Transform raw expense records into staging-ready records."""
    ...
    def _parse_amount(
        ...
        """
        Parse common numeric/currency representations.

        Supports:
        1234.56
        $1,234.56
        (1234.56)  -> negative (accounting notation)
        """
    ...
    def transform(
        ...
        """Transform one raw expense record."""

        parse_errors: list[str] = []

        return {
            "expense_id": self._clean_text(
            ...
            "expense_category": self._clean_text(
                record.get("expense_category")
            ),
            ...
            "paid_by": self._clean_text(
                record.get("paid_by")
            ),
            "paid_by_partner_id": self._clean_text(
